...
const CreateSubCategory = () => {
  ...
  const createSubCategoryHandle = async (e) => {
    e.preventDefault();
    const categoryData = {
      categoryId: category,
      titleOz,
    ...
    const { data } = await axios.post(`${categoryUrl}sub-category`, categoryData, {
      headers: {
        Authorization: access_token,
      },
    });
    if (data) {
      navigate("/category/sub-categories");
      toast.success(t("added-sub-category"));
    }
  };
  useEffect(() => {
                ...
                <form onSubmit={createSubCategoryHandle}>
                  ...
                  <div className="flex mt-3">
                    <label htmlFor="file-upload">
                      ...
                      <div className="mr-2 flex w-full bg-gray-100 dark:bg-gray-700/50 justify-center items-center rounded-md border-2 border-dashed border-gray-300 p-3 py-6 cursor-pointer">
